...
// includeWithVariables('../header.php', array('pos' => '../'));
?>
...
$sql = "SELECT * FROM posts WHERE username = '$profileUsername'";
        ...
        <div class="top">
          ...
          <?php 
            if ( isset($_SESSION['username']) && $_SESSION['username'] == $row['username']) {
              ?> <button onclick="deletePost(<?php echo $row['id'] ?>)" id="deletePostBtn">delete</button> <?php
            }
          ?>
        </div>
        <div class="bottom">
